...
func TestShouldReturnInventoryId(t *testing.T) {
	html := `
	<table>
			<tr>
	...
	actual := ExtractInventoryOrderId(GetTestSelection(html))
...
func TestShouldReturnEmptyStringOnInventoryId(t *testing.T) {
	html := `
	<table>
			<tr>
