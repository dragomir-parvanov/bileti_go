...
func TestShouldReturnLoggingDeadlineToExtension(t *testing.T) {
	html := `
	<table>
		<tr>
...
`
	result := ExtractLoggingDeadlineToExtension(GetTestSelection(html))
...
func TestShouldReturnZeroTimeIfLoggingDeadlineToExtensionIsEmpty(t *testing.T) {
	html := `
	<table>
		<tr>
