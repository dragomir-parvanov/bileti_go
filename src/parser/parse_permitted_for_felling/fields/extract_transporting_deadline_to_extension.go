...
func ExtractTransportingDeadlineToExtension(selection *goquery.Selection) time.Time {
	line := selection.Find("td:contains('За извоз на материалите до :')").First().Text()
